...
*/
    ...
    public static class PerlinNoise
    {
        ...
        public static Point Noise(Point point, double width, double height)
        {
            //PerlinNoise perlinNoise = new PerlinNoise( 99 );
            double widthDivisor = 1 / width;
            double heightDivisor = 1 / height;
            ...
            // First octave
            double v1 = ( PerlinNoise.Noise( 2 * point.X * widthDivisor, 2 * point.Y * heightDivisor, -0.5 ) + 1 ) / 2 * 0.7;
            // Second octave
            double v2 = ( PerlinNoise.Noise( 4 * point.X * widthDivisor, 4 * point.Y * heightDivisor, 0 ) + 1 ) / 2 * 0.2;
            // Third octave
            double v3 = ( PerlinNoise.Noise( 8 * point.X * widthDivisor, 8 * point.Y * heightDivisor, +0.5 ) + 1 ) / 2 * 0.1;

            v1 = Math.Min( 1, Math.Max( 0, v1 ) );
            v2 = Math.Min( 1, Math.Max( 0, v2 ) );
            v3 = Math.Min( 1, Math.Max( 0, v3 ) );
